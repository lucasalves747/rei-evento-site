...
import imageCelular from "@/assets/heroCelular.png"
import imageTablete from "@/assets/hero-tablet.png"
import backmobile from "@/assets/black_red_background.png"
...
export const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background pt-8 pb-16 sm:pt-0 md:pt-24 sm:pb-24">
      ...
      <div
        className="absolute inset-0 bg-cover bg-center opacity-80  md:hidden block"
        style={{ backgroundImage: `url(${backmobile})` }}
      />
      ...
      <div className="container mx-auto px-5 sm:px-8 md:px-10 relative z-10">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-12 lg:gap-16 items-center justify-center sm:text-center lg:text-left">
          ...
          <div className="space-y-10 w-full max-w-2xl mx-auto lg:mx-0">
            ...
            {/* tablete */}
            <div className="rounded-3xl overflow-hidden hidden sm:block md:hidden shadow-[0_0_25px_rgba(255,0,0,0.3)]">
              <img src={imageTablete} alt=""/>
            </div>

             {/* Celular */}
            <div className="rounded-3xl overflow-hidden sm:hidden shadow-[0_0_25px_rgba(255,0,0,0.3)]">
                ...
                <div className="flex justify-center lg:justify-start">
                  <a href="https://link.salee.ai/widget/survey/el7zf7YLfRcmP8NN2SM2">
                    <Button
                      variant="hero"
                      size="lg"
                      className="w-full sm:w-auto text-sm sm:text-lg px-8 sm:px-12 py-5 h-auto animate-glow"
                    >
