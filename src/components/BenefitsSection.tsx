...
export const BenefitsSection = () => {
  return (
    <section className="pb-12 md:pt-10 bg-[#EE0900]/70">
      <div className="container mx-auto px-4 sm:px-6 md:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 lg:gap-16 items-center">
          ...
          <Card className="bg-primary/0 pt-10 pb-10 border-none ">
           ...
           <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-snug sm:leading-tight sm:text-center px-2 lg:text-left text-white">
            ...
            <p className="text-base sm:text-lg text-white leading-relaxed px-2 sm:text-center lg:text-left">
        ...
        <Card className="bg-black p-5 mt-10 mx-2 sm:mx-20   hover:border-white/50  hover:shadow-lg hover:shadow-white/20">
                    <div className="px-2 sm:text-center  ">
